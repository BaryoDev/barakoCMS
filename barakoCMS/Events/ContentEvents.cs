    ...
    string? SearchText)
{
    ...
    public void Deconstruct(out Guid id, out string contentType, out Dictionary<string, object> data, out Models.ContentStatus status, out Guid createdBy) =>
        (id, contentType, data, status, createdBy) = (Id, ContentType, Data, Status, CreatedBy);
}
    ...
    string? SearchText)
{
    ...
    public void Deconstruct(out Guid id, out Dictionary<string, object> data, out Guid updatedBy) =>
        (id, data, updatedBy) = (Id, Data, UpdatedBy);
}
