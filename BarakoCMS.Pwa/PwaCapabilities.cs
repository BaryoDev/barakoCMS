...
/// </remarks>
public static class PwaCapabilities
{
    /// <summary>Read the record of who installed the progressive web app.</summary>
    public const string ViewPwaInstalls = "view_pwa_installs";
    ...
    internal static readonly string[] All = [ViewPwaInstalls];
}
