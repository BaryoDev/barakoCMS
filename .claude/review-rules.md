...
Read by the adversarial-review skill (arnelirobles/lean-agent) before any code. Each rule is answered yes or no with a line. CLAUDE.md is the coding standard; these are the questions reviews keep needing.
