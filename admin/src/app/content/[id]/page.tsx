...
export default function EditContentPage() {
    ...
    // Handle params potentially being undefined or array
                        ...
                        <Card className="bg-slate-800/50 border-slate-700 mb-6">
                            ...
                            <CardContent>
                                <div className="space-y-2 mb-4">
                                    ...
                                    <Select value={(status ?? ContentStatus.Draft).toString()} onValueChange={(v) => setStatus(parseInt(v) as ContentStatus)}>
