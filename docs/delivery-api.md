...
**Security is the one exception.** A change that closes a data exposure ships in the next release
whatever its number, as 3.20.0 did. It is still recorded under the same Delivery API lead and under
