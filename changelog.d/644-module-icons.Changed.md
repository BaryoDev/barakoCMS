- **New icons for the fourteen module packages.** Each keeps the ground colour it already had, with a
  ...
  tooling rather than feature modules and keep the icons they had. No project file changed:
  `Directory.Build.props` already packs each project's `assets/icon.png` as its `PackageIcon`.
