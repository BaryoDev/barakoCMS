...
- **A scheduled publish and a concurrent edit could silently undo each other.** The writer stored the
  ...
  a due draft and committed, an edit that had loaded the earlier copy appended cleanly afterwards,
...
### Security
>>>>>>> 2aa620d (restore the changelog entries and take the coordinated module version)
