...
public class Endpoint(
    ...
    ISensitivityService sensitivity) : Endpoint<Request, PaginatedResponse<FileUsageRow>>
{
    ...
    public override async Task HandleAsync(Request req, CancellationToken ct)
    {
        ...
        {
            Items = await FileUsage.RowsAsync(page, caller, permissions, sensitivity, HttpContext, ct),
            Page = req.Page,
